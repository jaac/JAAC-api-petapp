...
public class UserResource {
    ...
    public UserDto readCustomer(@PathVariable String id) throws UserIdNotFoundException {
        return this.userController.readUser(id, new Role[] {Role.REGISTERED}).orElseThrow(() -> new UserIdNotFoundException(id));
    }

    @RequestMapping(value = USER_ID, method = RequestMethod.GET)
    public UserDto readUserRegistered(@PathVariable String id) throws UserIdNotFoundException {
        return this.userController.readUserbyId(id, new Role[] {Role.REGISTERED}).orElseThrow(() -> new UserIdNotFoundException(id));
    }
